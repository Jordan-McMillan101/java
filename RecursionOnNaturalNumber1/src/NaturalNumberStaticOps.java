...
public final class NaturalNumberStaticOps {
     ...
     * @updates {@code in.content}
     * @updates {@code out.content}
     * @requires <pre>
     * {@code in.is_open and out.is_open}
     * </pre>
     * @ensures <pre>
     * {@code [displays a menu of available commands, prompts the user to
     ...
     * </pre>
     * @ensures <pre>
     * {@code out.content = #out.content * [display of n with commas]}
     * </pre>
     */
...
//
//        NaturalNumber digit = new NaturalNumber(1000);
//        if (n < 1000) {
//            out.println(n);
//        }
//
//    }
     ...
     * @ensures <pre>
     * {@code toStringWithCommas = [String representation of n with commas]}
     * </pre>
     */
