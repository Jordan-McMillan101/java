...
public final class SequenceSmoothTest {
    ...
    public void test3() {
        ...
        Sequence<Integer> seq2 = this.createFromArgs(8, 15);
    ...
    public void test4() {
        ...
        Sequence<Integer> seq1 = this.createFromArgs(100, 200, 200, 500);
        Sequence<Integer> expectedSeq1 = this
                .createFromArgs(100, 200, 200, 500);
        Sequence<Integer> seq2 = this.createFromArgs(200, 500);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(150, 200, 350);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void test5() {
        ...
        Sequence<Integer> seq1 = this.createFromArgs(3, 4);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(3, 4);
        Sequence<Integer> seq2 = this.createFromArgs(234, 2345);
